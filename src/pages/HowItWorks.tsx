...
export default function HowItWorks() {
  ...
  const sellerSteps = [
    ...
    },
    {
      ...
      description: "După confirmarea livrării, banii sunt transferați în portofelul tău. Pe Marketplace România vinzi cu 0% comision — doar abonament fix!"
    }
  ];
  ...
  return (
    <>
      <SEOHead 
        title="Cum Funcționează Marketplace România | Ghid Complet Cumpărători și Vânzători"
        description="Cum funcționează Marketplace România? Ghid complet pentru cumpărători și vânzători pe Marketplace România. 0% comision pe vânzări, abonamente fixe de la 11 LEI/lună. Primul marketplace din România construit cu AI."
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground">
                Ghid complet pentru a cumpăra și vinde pe Marketplace România — cel mai mare marketplace online din România cu 0% comision și abonamente fixe
              </p>
            </div>
            ...
            <section className="mb-12">
              <Card className="bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20">
                <CardContent className="pt-6 text-center">
                  <h2 className="text-2xl font-bold mb-4">Marketplace România — 0% Comision pe Vânzări!</h2>
                  <p className="text-muted-foreground mb-4">
                    Pe Marketplace România plătești doar abonamentul fix lunar. Tot ce vinzi rămâne 100% al tău! Fără taxe ascunse, fără comisioane.
                  </p>
            ...
            <div className="text-center bg-muted/50 rounded-2xl p-8">
              <h2 className="text-2xl font-bold mb-4">Gata să Începi pe Marketplace România?</h2>
              <p className="text-muted-foreground mb-6">
                Înregistrează-te gratuit pe Marketplace România și alătură-te comunității. Primele 30 de zile sunt gratuite!
              </p>
