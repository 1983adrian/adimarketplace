...
const COUNTRY_NAMES: Record<string, string> = {
  GB: 'United Kingdom', US: 'United States', RO: 'Romania', DE: 'Germany',
  FR: 'France', IT: 'Italy', ES: 'Spain', NL: 'Netherlands', BE: 'Belgium',
  PL: 'Poland', CZ: 'Czech Republic', HU: 'Hungary', BG: 'Bulgaria',
  SE: 'Sweden', DK: 'Denmark', NO: 'Norway', AT: 'Austria', CH: 'Switzerland',
  IE: 'Ireland', PT: 'Portugal', GR: 'Greece', FI: 'Finland', HR: 'Croatia',
  ...
  AL: 'Albania', MD: 'Moldova', UA: 'Ukraine', TR: 'Turkey', CY: 'Cyprus',
  MT: 'Malta', LU: 'Luxembourg', IS: 'Iceland', LI: 'Liechtenstein', MC: 'Monaco',
...
function getCountryFromTimezone(timezone: string): { code: string; name: string } | null {
  const timezoneCountryMap: Record<string, { code: string; name: string }> = {
    ...
    'Europe/Sarajevo': { code: 'BA', name: 'Bosnia and Herzegovina' },
    'Europe/Podgorica': { code: 'ME', name: 'Montenegro' },
    'Europe/Skopje': { code: 'MK', name: 'North Macedonia' },
    'Europe/Tirane': { code: 'AL', name: 'Albania' },
    'Europe/Chisinau': { code: 'MD', name: 'Moldova' },
    'Europe/Kiev': { code: 'UA', name: 'Ukraine' },
    'Europe/Kyiv': { code: 'UA', name: 'Ukraine' },
    'Europe/Istanbul': { code: 'TR', name: 'Turkey' },
    'Europe/Nicosia': { code: 'CY', name: 'Cyprus' },
    'Europe/Malta': { code: 'MT', name: 'Malta' },
    'Europe/Luxembourg': { code: 'LU', name: 'Luxembourg' },
    'Atlantic/Reykjavik': { code: 'IS', name: 'Iceland' },
    'Europe/Monaco': { code: 'MC', name: 'Monaco' },
