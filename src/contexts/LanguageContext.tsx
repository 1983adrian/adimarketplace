...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'dashboard.subscription': 'Seller Subscription',
    'dashboard.subscribed': 'Active until',
    'dashboard.subscribe': 'Subscribe to list items for sale',
    'dashboard.manageSubscription': 'Manage Subscription',
    'dashboard.subscribeNow': 'Subscribe Now',
    'dashboard.sellerBenefits': 'Seller benefits: Create unlimited listings, 15% commission on sales (only when you sell).',
    ...
    'dashboard.subscribeToSell': 'Subscribe to become a seller and create listings',
    'dashboard.createListing': 'Create Listing',
    'dashboard.loading': 'Loading...',
    'dashboard.subscriptionActivated': 'Subscription activated!',
    'dashboard.canCreateListings': 'You can now create listings.',
    'dashboard.subscriptionCanceled': 'Subscription canceled',
    'dashboard.canSubscribeAnytime': 'You can subscribe anytime.',
    ...
    'admin.sellerSubscription': 'Seller Subscription',
  ...
  ro: {
    ...
    'dashboard.subscription': 'Abonament Vânzător',
    'dashboard.subscribed': 'Activ până la',
    'dashboard.subscribe': 'Abonează-te pentru a lista articole la vânzare',
    'dashboard.manageSubscription': 'Gestionează Abonamentul',
    'dashboard.subscribeNow': 'Abonează-te Acum',
    'dashboard.sellerBenefits': 'Beneficii vânzător: Creează anunțuri nelimitate, comision 15% la vânzări (doar când vinzi).',
    ...
    'dashboard.subscribeToSell': 'Abonează-te pentru a deveni vânzător și a crea anunțuri',
    'dashboard.createListing': 'Creează Anunț',
    'dashboard.loading': 'Se încarcă...',
    'dashboard.subscriptionActivated': 'Abonament activat!',
    'dashboard.canCreateListings': 'Acum poți crea anunțuri.',
    'dashboard.subscriptionCanceled': 'Abonament anulat',
    'dashboard.canSubscribeAnytime': 'Te poți abona oricând.',
    ...
    'admin.sellerSubscription': 'Abonament Vânzător',
